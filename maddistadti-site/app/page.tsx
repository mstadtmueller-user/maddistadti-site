    ...
    <main className="min-h-screen bg-[#faf9f6] text-[#403d39] p-6 font-light">
      <div className="max-w-4xl mx-auto">
        ...
        <section className="grid gap-10 md:grid-cols-2">
          <Card className="shadow-none bg-[#f9f7f4] border border-[#dedbd7]">
        ...
        <div className="text-center mt-20">
          <Button asChild className="bg-[#2e2b28] text-white hover:bg-[#4a4744] tracking-wide px-6 py-2 text-sm">
            <a
